...
static void lovrGraphicsInitBuffers() {
  ...
  MeshAttribute position = { vertexBuffer, 0, stride, F32, 3, 0, false, false };
  MeshAttribute normal = { vertexBuffer, 12, stride, F32, 3, 0, false, false };
  MeshAttribute texCoord = { vertexBuffer, 24, stride, F32, 2, 0, false, false };
  MeshAttribute drawId = { state.buffers[STREAM_DRAW_ID], 0, 0, U8, 1, .integer = true };
  MeshAttribute identity = { state.identityBuffer, 0, 0, U8, 1, .divisor = 1, .integer = true };
